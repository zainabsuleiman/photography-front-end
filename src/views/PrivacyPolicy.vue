<template>
  <div class="container mt-2 card shadow py-4 px-6">
    <h1>Privacy Policy for Buy From Women</h1>

    <p>
      At Buy From Women Platform, accessible from https://www.buyfromwomen.rw,
      one of our main priorities is the privacy of our visitors. This Privacy
      Policy document contains types of information that is collected and
      recorded by Buy From Women Platform and how we use it.
    </p>
    ...
    <p>
      ...
      and/or collect in Buy From Women Platform. This policy is not applicable
    ...
    <p>
      Buy From Women Platform follows a standard procedure of using log files.
    ...
    <P
      ...
      advertising partners of Buy From Women Platform.</P
    >

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Buy From Women Platform, which are
    ...
    <p>
      Note that Buy From Women Platform has no access to or control over these
    ...
    <p>
      Buy From Women Platform's Privacy Policy does not apply to other
    ...
    <p>
      Buy From Women Platform does not knowingly collect any Personal
